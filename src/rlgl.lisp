...
;;} rlRenderBatch;
(defcstruct %render-batch
  (buffer-count :int)
  (current-buffer :int)
  (vertex-buffer (:pointer (:struct %vertex-buffer)))
  (draws (:pointer (:struct %draw-call)))
  (draw-counter :int)
  (current-depth :float))
...
(defcenum framebuffer-attach-type
...
(defcenum framebuffer-attach-texture-type
...
(defcfun ("rlBlitFramebuffer" blit-framebuffer) :void
...
(defcfun ("rlEnablePointMode" enable-point-mode) :void
"Enable point mode")
...
(defcfun ("rlLoadRenderBatch" load-render-batch) (:struct %render-batch)
...
(defcfun ("rlGetGlTextureFormats" get-gl-texture-formats) :void
  ...
  (format :int)
  (gl-internal-format (:pointer :int))
...
(defcfun ("rlFramebufferAttach" framebuffer-attach) :void
  ...
  (fbo-id :unsigned-int)
  (tex-id :unsigned-int)
  (attach-type framebuffer-attach-type)
  (tex-type :int)
  (mip-level :int))
...
(defcfun ("rlLoadShaderProgram" load-shader-program) :unsigned-int
  ...
  (v-shader-id :unsigned-int)
  (f-shader-id :unsigned-int))
...
(defcfun ("rlComputeShaderDispatch" compute-shader-dispatch) :void
  ...
  (group-x :unsigned-int)
  (group-y :unsigned-int)
  (group-z :unsigned-int))
...
(defcfun ("rlCopyShaderBuffer" copy-shader-buffers) :void
  ...
  (dest-id :unsigned-int)
  (src-id :unsigned-int)
  (dest-offset :unsigned-int)
  (src-offset :unsigned-int)
  (count :unsigned-int))
